...
namespace OOPProject
{
	...
	{
		public static LibraryBransh Seed()
		{
			// ── Librarian ────────────────────────────────────────────
			Librarian manager = new("Abdelrahman Osama", "022641518123", "MEM-0",salary: 8500m, new DateOnly(2019, 3, 15));


			// ── Branch ───────────────────────────────────────────────
			LibraryBransh branch = new("BR-01", "City Library — Nasr City Branch", "15 Nasr Road, Nasr City, Cairo",
			"01012345678", "Sat–Thu: 09:00 AM – 09:00 PM", manager);


			branch.RegisterMember("Ahmed Kamal", "01098765432",
			new DateOnly(1998, 5, 10), "ahmed@email.com",
			new DateOnly(2023, 1, 20));

			branch.RegisterMember("Nour Hassan", "01155556677",
